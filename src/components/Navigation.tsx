...
const Navigation = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 bg-[hsl(var(--background)/0.6)] backdrop-blur-sm border-b border-bg-[hsl(var(--background)/0.8)]"
 ...
 <a
  ...
  className="inline-block rounded-lg bg-gradient-to-r from-blue-400 to-blue-300 shadow-md transition duration-300 hover:from-blue-500 hover:to-blue-500 hover:shadow-lg"
>
  <div className="bg-background rounded-md px-1 py-0.2">
    <Button className="py-0.5 px-6 text-[1rem] cursor-pointer">Sign In</Button>
  </div>
</a>
